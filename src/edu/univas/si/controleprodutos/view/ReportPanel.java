...
import edu.univas.si.controleprodutos.bi.VendasBI;
import edu.univas.si.controleprodutos.components.GeneralTableModel;
...
public class ReportPanel extends JPanel implements PrintableInterface{
	...
	private String[] _itensCombo = {" ","Ano","Mês","Período","Listar todas"};
    ...
    public void printJTable(){
		try {
			MessageFormat headerFormat = new MessageFormat("Relatório - Vendas");
	...
	/**
	 * Abaixo segue alguns métodos chamados para formatar
